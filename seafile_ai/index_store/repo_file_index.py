...
from seafile_ai.index_store.utils import get_document_add_params, parse_sdoc_to_add_params, parse_docx_to_add_params, parse_pptx_to_add_params
        ...
        for file_info in files:
            ...
            if file_content:
                ...
                if ext_lower == '.sdoc':
                    ...
                    add_params = parse_docx_to_add_params(file_content, retrieval_model, index_name, path)
                    bulk_add_params.extend(add_params)
                elif ext_lower == '.pptx':
                    add_params = parse_pptx_to_add_params(file_content, retrieval_model, index_name, path)
                    bulk_add_params.extend(add_params)
