...
IMAGE_TAGS_SERVICE_URL = os.getenv('IMAGE_TAGS_SERVICE_URL') or IMAGE_TAGS_SERVICE_URL
IMAGE_TAGS_SERVICE_KEY = os.getenv('IMAGE_TAGS_SERVICE_KEY') or IMAGE_TAGS_SERVICE_KEY

OCR_SERVICE_TYPE = os.getenv('OCR_SERVICE_TYPE') or OCR_SERVICE_TYPE
OCR_SERVICE_URL = os.getenv('OCR_SERVICE_URL') or OCR_SERVICE_URL
