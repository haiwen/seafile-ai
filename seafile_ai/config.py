...
# ListFiles tool
DEFAULT_LIST_FILES_MAX_RECORDS = 1000

# ReadFiles tool
READ_FILES_MAX_FILES = 5
READ_FILES_MAX_FILE_SIZE = 10 * 1024 * 1024
READ_FILES_MAX_TOTAL_CHARS = 15000
...
LOG_FILE = os.path.join(os.getenv('LOG_DIR', '/opt/seafile/logs'), 'seafile-ai.log')

SEAFILE_SERVER_URL = os.getenv('SEAFILE_SERVER_URL', '')
SECRET_KEY = os.getenv('JWT_PRIVATE_KEY', '')
SEASEARCH_URL = os.getenv('SEASEARCH_URL', '')
SEASEARCH_TOKEN = os.getenv('SEASEARCH_TOKEN', '')

MYSQL_DB_HOST = os.getenv('SEAFILE_MYSQL_DB_HOST', 'db')
MYSQL_DB_PORT = os.getenv('SEAFILE_MYSQL_DB_PORT', 3306)
MYSQL_DB_USER = os.getenv('SEAFILE_MYSQL_DB_USER', 'root')
MYSQL_DB_PWD = os.getenv('SEAFILE_MYSQL_DB_PASSWORD', '')
MYSQL_SEAHUB_DB_NAME = os.getenv('SEAFILE_MYSQL_DB_SEAHUB_DB_NAME', 'seahub_db')
MYSQL_SEAFILE_DB_NAME = os.getenv('SEAFILE_MYSQL_DB_SEAFILE_DB_NAME', 'seafile_db')
MYSQL_CCNET_DB_NAME = os.getenv('SEAFILE_MYSQL_DB_CCNET_DB_NAME', 'ccnet_db')
...
# Face embedding is no longer supported. These settings are retained temporarily
# for compatibility and are not used by the application.
FACE_EMBEDDING_SERVICE_URL = os.getenv('FACE_EMBEDDING_SERVICE_URL', '')
FACE_EMBEDDING_SERVICE_KEY = os.getenv('FACE_EMBEDDING_SERVICE_KEY', '')

LOG_LEVEL = os.getenv('SEAFILE_AI_LOG_LEVEL', 'info')
...
# metadata config
METADATA_SERVER_URL = os.getenv('INNER_METADATA_SERVER_URL', 'http://127.0.0.1:8084')

# ListFiles tool config
DEFAULT_LIST_FILES_MAX_RECORDS = int(os.getenv('SEAFILE_AI_LIST_FILES_MAX_RECORDS', DEFAULT_LIST_FILES_MAX_RECORDS))

# ReadFiles tool config
READ_FILES_MAX_FILES = int(os.getenv('SEAFILE_AI_READ_FILES_MAX_FILES', READ_FILES_MAX_FILES))
READ_FILES_MAX_FILE_SIZE = int(os.getenv('SEAFILE_AI_READ_FILES_MAX_FILE_SIZE', READ_FILES_MAX_FILE_SIZE))
READ_FILES_MAX_TOTAL_CHARS = int(os.getenv('SEAFILE_AI_READ_FILES_MAX_TOTAL_CHARS', READ_FILES_MAX_TOTAL_CHARS))
